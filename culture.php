...
<head>
    ...
    <title>Heritage & Culture | THE TOUCH MAGAZINE</title>
    <!-- Google Fonts -->
...
<body class="bg-light text-navy font-sans antialiased">
    ...
    <header class="max-w-7xl mx-auto px-4 sm:px-8 py-16 fade-up">
        ...
        <h1 class="font-serif text-5xl md:text-7xl font-black text-navy mb-6">Heritage, Culture & Environment</h1>
    </header>
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-8">
            <article class="fade-up">
                <div class="aspect-[21/9] w-full bg-light overflow-hidden mb-10 shadow-sm border border-gray-300 p-1">
                    <img src="images/culture.png" class="w-full h-full object-cover">
                </div>
                <div class="news-line-thick w-16 mb-6"></div>
                <h2 class="font-serif text-4xl md:text-5xl font-bold leading-tight mb-6">Monuments of Antiquity: Restoration at Anuradhapura</h2>
                <div class="flex items-center text-xs font-bold text-navy/50 uppercase tracking-widest mb-10 pb-6 border-b border-gray-300">
                    <span class="text-navy mr-4">By Tariq Silva</span>
                    <span>10 Min Read</span>
                </div>
                
                <div class="prose prose-lg text-navy/80 font-medium leading-relaxed">
                    <p class="mb-6 font-bold text-xl text-navy">Archaeologists unearth compelling evidence detailing advanced ancient hydraulic systems, shedding new light on Sri Lankan heritage.</p>
                    <p class="mb-6">The ongoing excavations around the sacred city of Anuradhapura continue to challenge modern assumptions about ancient engineering. Our team traveled to the core historical sites to document the massive restoration effort underway to save fragile artifacts from environmental degradation.</p>
                </div>
            </article>
        </div>
    </main>
