...
<head>
    ...
    <title>Sports & Wellness | THE TOUCH MAGAZINE</title>
    <!-- Google Fonts -->
...
<body class="bg-light text-navy font-sans antialiased">
    ...
    <header class="max-w-7xl mx-auto px-4 sm:px-8 py-16 fade-up">
        ...
        <h1 class="font-serif text-5xl md:text-7xl font-black text-navy mb-6">Sports, Wellness & Entertainment</h1>
    </header>
    ...
    <main class="bg-paper border-t border-gray-300 py-20 min-h-screen">
        <div class="max-w-4xl mx-auto px-4 sm:px-8">
            <article class="fade-up">
                ...
                <h2 class="font-serif text-4xl md:text-5xl font-bold leading-tight mb-6">Holistic Living: The Intersection of Island Life and Performance</h2>
                <div class="flex items-center text-xs font-bold text-navy/50 uppercase tracking-widest mb-10 pb-6 border-b border-gray-300">
                    <span class="text-navy mr-4">By Maya Jayasinghe</span>
                    <span>5 Min Read</span>
                </div>
                
                <div class="prose prose-lg text-navy/80 font-medium leading-relaxed">
                    <p class="mb-6 font-bold text-xl text-navy">From national cricket triumphs to the resurgence of Ayurvedic retreats catering to global high-performers.</p>
                    <p class="mb-6">The concept of wellness is deeply ingrained in the island's DNA. Today, modern athletic strategies are merging with traditional recuperative practices. We discuss how top sportsmen in Sri Lanka are employing these dual methods to enhance longevity on the field.</p>
                </div>
            </article>
        </div>
    </main>
