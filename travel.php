...
<head>
    ...
    <title>Travel & Photography | THE TOUCH MAGAZINE</title>
    <!-- Google Fonts -->
...
<body class="bg-light text-navy font-sans antialiased">
    ...
    <header class="max-w-7xl mx-auto px-4 sm:px-8 py-16 fade-up">
        ...
        <h1 class="font-serif text-5xl md:text-7xl font-black text-navy mb-6">Travel & Photography</h1>
    </header>
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-8">
            <article class="fade-up">
                <div class="aspect-[21/9] w-full bg-light overflow-hidden mb-10 shadow-sm border border-gray-300 p-1">
                    <img src="images/travel.png" class="w-full h-full object-cover">
                </div>
                <div class="news-line-thick w-16 mb-6"></div>
                <h2 class="font-serif text-4xl md:text-5xl font-bold leading-tight mb-6">The Hidden Valleys: Rediscovering the Central Highlands</h2>
                <div class="flex items-center text-xs font-bold text-navy/50 uppercase tracking-widest mb-10 pb-6 border-b border-gray-300">
                    <span class="text-navy mr-4">By Anya Fernando</span>
                    <span>8 Min Read</span>
                </div>
                
                <div class="prose prose-lg text-navy/80 font-medium leading-relaxed">
                    <p class="mb-6 font-bold text-xl text-navy">Away from the crowded coastal belts lies an interior landscape shrouded in mist and history.</p>
                    <p class="mb-6">The train ride towards the central highlands has always been lauded as one of the most scenic global routes. Yet, stepping off the beaten path uncovers valleys that have managed to escape the heavy footprints of modern tourism.</p>
                    <p class="mb-6">Full pictorial journal available exclusively inside the current digital and print edition of THE TOUCH MAGAZINE.</p>
                </div>
            </article>
        </div>
    </main>
